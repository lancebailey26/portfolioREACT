      ...
      <div className="contentContainer">
        <div data-aos="flip-up" data-aos-duration="1500" style={nowrap} className="box">
          <ul style={left}>
            ...
            <li>
              <a style={link} href="https://www.linkedin.com/in/lance-bailey/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
            ...
            <a style={link} href="https://www.twitter.com/lancebailey26">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
                height="32"
            ...
            <li>
              <a style={link} href="https://www.instagram.com/lancebailey">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
            ...
            <li>
              <a style={link} href="https://www.twitch.tv/tro_3k">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
            ...
            <li >
              <a style={link} href="mailto:lancebailey222@gmail.com">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
...
<br/>
        <iframe title='spotify' className='playlist' src="https://open.spotify.com/embed/playlist/0M94woUpkj37XYSWFtXYV3?utm_source=generator&amp;theme=0" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
        </div>
        <div className='box'>
