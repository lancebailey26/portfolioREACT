...
export default function Blog() {
    ...
    const getBlog = async () => {
        ...
        const bloglist = await axios.get('https://boiling-earth-09518.herokuapp.com/api/blogs/')
        const val = bloglist.data.length
        const res = await axios.get(`https://boiling-earth-09518.herokuapp.com/api/blogs/${val}`)
        const data = res.data
        // console.log(data)
        setOriginal(val)
        getBlogData(data)
